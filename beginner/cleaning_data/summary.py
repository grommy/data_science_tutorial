...
g1800s = pd.read_csv('DataSets/gapminder.csv', index_col=0)
...
# Check that there is more than one instance of each country
...
gapminder_agg.to_csv('DataSets/gapminder_agg.csv')
